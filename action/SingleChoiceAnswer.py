...
class SingleChoiceAnswer(Action):
    NAME = "单选回答器"
    DESC = "回答单选问题"
    PROMPT_TEMPLATE = (Base_DIR / 'prompt' / 'SingleChoicePrompt.txt').read_text(encoding="utf-8")
    ...
    def build_prompt(self, info: str, question: str, reasoning: bool = REASONING) -> "SingleChoiceAnswer":
        """
        构建prompt
